#include "ProtocolAllStorageInfoRes.h"
#include "../../Player.h"

CProtocolAllStorageInfoRes::CProtocolAllStorageInfoRes(void)
{
#if _GAME_VERSION_ == _TIAN_SHI_ZHI_ZHAN_PC_
	SetProtocolIdResOrSyn(ResAllStorageInfo);
#endif
...
int CProtocolAllStorageInfoRes::Decode(CStreamReadWrite *pStreamBuf)
{
	int handleLength=0;
	...
	TRACE_OUTPUT(_T("CProtocolAllStorageInfoRes 跳过字节:%d\n"),restBytes);

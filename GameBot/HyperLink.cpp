...
{
	HINSTANCE result = ShellExecute(NULL, NULL, url, NULL, NULL, showcmd);
		//ShellExecute(NULL, _T("open"), _T("explorer.exe"), url, NULL, showcmd);//ShellExecute(NULL, _T("open"), url, NULL, NULL, showcmd);
	//TRACE_OUTPUT(_T("ShellExecute ret:%d\n"),result);
	return (int)result;
}
